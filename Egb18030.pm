...
#
# GB18030 regexp ignore case option
#
sub Egb18030::ignorecase(@) {
...
ITER_DO:
    {
        for my $prefix (@INC) {
            ...
            if (Egb18030::f($realfilename)) {
                ...
                my $module_mtime = (Egb18030::stat("$FindBin::Bin/GB18030.pm"))[9];
                if (Egb18030::e("$realfilename.e") and ($mtime < $e_mtime) and ($module_mtime < $e_mtime)) {
                    my $fh = Symbol::gensym();
...
=item length by GB18030 character
  ...
  is omitted, it returns the GB18030::length of $_.
